...
<body>
	<div style="padding-left:100px;background-color: lightblue; border-color:black; border-style:solid; height:300px; width:350px;">
		<form method="post" action="index.jsp">
			<h1>Learners Academy Version 3.0</h1>
